...
|Hex|Mnemonic|Pops|Pushes|Tier|Description|Gas|Additional items|Side effects|Tentative|Internal|
|----|----|----|----|----|----|----|----|----|----|----|
...
|0x20|KECCAK256 &#124; SHA3|2|1|Special|Compute KECCAK-256 hash|30|0|true| | |
...
|0xb0|JUMPTO|1|0|VeryLow|Alter the program counter to a jumpdest| | | |true| |
|0xb1|JUMPIF|2|0|Low|Conditionally alter the program counter| | | |true| |
|0xb2|JUMPSUB|1|0|Low|Alter the program counter to a beginsub| | | |true| |
|0xb3|JUMPV|1|0|Mid|Alter the program counter to a jumpdest| | | |true| |
|0xb4|JUMPSUBV|1|0|Mid|Alter the program counter to a beginsub| | | |true| |
|0xb5|BEGINSUB|0|0|Special|Set a potential jumpsub destination| | | |true| |
|0xb6|BEGINDATA|0|0|Special|Begine the data section| | | |true| |
|0xb7|RETURNSUB|1|0|Mid|Return to subroutine jumped from| | | |true| |
|0xb8|PUTLOCAL|1|0|VeryLow|Pop top of stack to local variable| | | |true| |
|0xb9|GETLOCAL|0|1|VeryLow|Push local variable to top of stack| | | |true| |
...
|0xff|SELFDESTRUCT &#124; SUICIDE|1|0|Special|Halt execution and register account for later deletion|5000|0|true| | |
...
* Забарный факт. В ходе этого этого исследования был найден баг средней тяжести в исходниках EVM на С++.
