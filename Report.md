...
// todo: ETH, что такое блок, зачем он, отличие от bitcoin
// что такое eip
...
## Память
Размер слова - 256бит (This was chosen to facilitate the Keccak256 hash scheme and elliptic-curve computations).
