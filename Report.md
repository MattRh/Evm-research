...
Например:
0. Функция `public function foo(uint count, int8[] arr) returns(uint r) { ... }`
0. Сигнатура `foo(uint,int8[])`
0. sha3(keccak256) хэш `5c767b9558d2d0c09eca458d4a6de90691964b2d08beda28b061558b0913b19f`
0. Хэш функции `5c767b95`

### Parameters passing
// как кодируются статичные данные и динамические структуры

### Boilerplate
// todo: что делает и может привести пример
...
## Testing
// todo: рассказать, как все плохо или не на столько плохо?, и есть ли свет в конце туннеля
